<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-black text-gray-800 dark:text-white">Tambah Kategori</h1>
                <p class="text-gray-500 dark:text-gray-400 mt-1">Buat kategori produk baru</p>
            </div>
            ...
            <form action="{{ route('categories.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                           placeholder="cth: Elektronik, Pakaian, Makanan"
